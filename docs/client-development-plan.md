...
- Windows 需要真实 Windows 环境执行 `scripts/build-client.ps1`，再运行 `scripts/verify-client-archive.ps1`、`scripts/smoke-agent-launch.ps1` 和 `scripts/smoke-client-launch.ps1`。
